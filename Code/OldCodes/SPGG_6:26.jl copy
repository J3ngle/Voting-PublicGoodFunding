...
# # Movement gain and loss
    ...
    p1 = heatmap(x, y, c', aspect_ratio=1, colorbar=false,  clims=clims)# clims=climsc=cgrad(:magma,rev=true),
    p2 = heatmap(x, y, g', aspect_ratio=1, colorbar=false,  clims=clims)# clims=climsc=cgrad(:magma,rev=true),
    p3 = heatmap(x, y, z1', aspect_ratio=1, colorbar=false,  clims=clims)# clims=climsc=cgrad(:magma,rev=true),
    p4 = heatmap(x, y, z2', aspect_ratio=1, colorbar=false,  clims=clims)# clims=climsc=cgrad(:magma,rev=true),
    p5 = heatmap(x, y, heatmap_population', aspect_ratio=1, colorbar=false,  clims=clims) # clims=clims c=cgrad(:magma,rev=true), 
